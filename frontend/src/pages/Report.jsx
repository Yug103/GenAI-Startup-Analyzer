              ...
              <div className="space-y-1">
                {Object.entries(category_scores).map(([key, score], i) => (
                  <div key={i} className="flex items-center gap-4 py-2">
                    <span className="w-[180px] text-sm text-gray-600 shrink-0 capitalize">{key.replace(/_/g, ' ')}</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5" ref={sectionRefs.risks}>
              <div className="flex items-center gap-2 mb-4">
                ...
                <h4 className="text-lg font-semibold text-red-600">Key Weaknesses</h4>
              </div>
              <div className="space-y-4">
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5" ref={sectionRefs.risks}>
              ...
              <div className="mt-6 border-t border-gray-100 pt-4">
                <h4 className="text-sm font-semibold text-gray-700 mb-3">Associated Risks</h4>
                ...
                <tbody className="divide-y divide-gray-100">
                  {competitors && competitors.map((c, i) => (
                    <tr key={i}>
                      ...
                      <td className="px-5 py-4 text-sm text-gray-600 capitalize">{c.type}</td>
